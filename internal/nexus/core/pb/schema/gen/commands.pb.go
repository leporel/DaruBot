...
type GetStatsReplay struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetStatsReplay) Reset() {
	*x = GetStatsReplay{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetStatsReplay) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetStatsReplay) ProtoMessage() {}

func (x *GetStatsReplay) ProtoReflect() protoreflect.Message {
	mi := &file_commands_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetStatsReplay.ProtoReflect.Descriptor instead.
func (*GetStatsReplay) Descriptor() ([]byte, []int) {
...
var file_commands_proto_rawDesc = []byte{
	...
	,
...
var file_commands_proto_goTypes = []interface{}{
	(*GetStatsRequest)(nil), // 0: Commands.GetStatsRequest
	(*GetStatsReplay)(nil),  // 1: Commands.GetStatsReplay
}
var file_commands_proto_depIdxs = []int32{
	0, // 0: Commands.Commander.GetStats:input_type -> Commands.GetStatsRequest
	1, // 1: Commands.Commander.GetStats:output_type -> Commands.GetStatsReplay
